      ...
      <header style={{ position: 'fixed', top: 0, left: 0, width: '100%', zIndex: 100, backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,.05)', background: 'rgba(6,7,12,.55)' }}>
        <div style={{ width: 'min(1180px, 92%)', margin: 'auto', height: 78, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            ...
            <Link to="/contact" style={{ padding: '13px 22px', borderRadius: 14, background: 'linear-gradient(135deg,#8f5cff,#5c6bff)', color: '#fff', textDecoration: 'none', fontWeight: 700, boxShadow: '0 12px 40px rgba(143,92,255,.3)', fontSize: '.9rem' }}>
              Solicită demo
            </Link>
          </div>
        </div>
      ...
      <div style={{ width: 'min(1220px, 92%)', margin: 'auto', minHeight: '100vh', display: 'grid', gridTemplateColumns: 'clamp(1fr, 1fr, 1.1fr) clamp(1fr, 1fr, .9fr)', alignItems: 'center', gap: 70, paddingTop: 120 }}
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 18, marginTop: 36, flexWrap: 'wrap' }}>
            <Link to="/contact" style={{ padding: '13px 22px', borderRadius: 14, background: 'linear-gradient(135deg,#8f5cff,#5c6bff)', color: '#fff', textDecoration: 'none', fontWeight: 700, boxShadow: '0 12px 40px rgba(143,92,255,.3)' }}>
              Solicită demo
            </Link>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24, alignItems: 'start' }}>
          {plans.map((p) => (
            <div key={p.name} className="niro-card" style={{
              ...
              <Link to="/contact" style={{ display: 'block', marginTop: 30, padding: '13px 22px', borderRadius: 14, background: p.featured ? 'linear-gradient(135deg,#8f5cff,#5c6bff)' : 'rgba(255,255,255,.06)', color: '#fff', textDecoration: 'none', fontWeight: 700, textAlign: 'center', border: p.featured ? 'none' : '1px solid rgba(255,255,255,.1)', boxShadow: p.featured ? '0 12px 40px rgba(143,92,255,.3)' : 'none' }}>
                Solicită demo
              </Link>
            </div>
          ))}
